...
void Preprocessor::run (NodeInfoContainer& s_t_infos, NodeInfoContainer& t_s_infos) {
    ...
    #pragma omp parallel sections num_threads(2)
    {
        #pragma omp section
        {
            ...
            dijkstra1.runNew(useFirstCostComponent, targetUb[0], targetUb[1], false);
        }
        #pragma omp section
        {
            //second cost component backward
            LexDijkstra dijkstra2{this->G, t_s_infos, s_t_infos};
            dijkstra2.runNew(!useFirstCostComponent, targetUb[1], targetUb[0], false);
        }
    }
    #pragma omp parallel sections num_threads(2)
    {
        #pragma omp section
        {
            ...
            dijkstra3.runNew(useFirstCostComponent, targetUb[0], targetUb[1], true);
        }
        #pragma omp section
        {
            //second cost component forward
            LexDijkstra dijkstra4{this->G, s_t_infos, t_s_infos};
            dijkstra4.runNew(!useFirstCostComponent, targetUb[1], targetUb[0], true);
        }
    }
}
